      ...
      <div className="card">
        {step === 1 && (
          <div>
            ...
            <div className="form-group">
              <label>מיקום</label>
              <input type="text" name="location" value={formData.location} onChange={handleChange} required placeholder="בתוך החברה או מקום חיצוני" />
            </div>
          </div>
        )}
        ...
        {step === 4 && (
          <div>
            ...
            <div className="form-group" style={{ marginBottom: '1.5rem' }}>
              <label>הזנת עלויות משוערות ותקציב (₪)</label>
